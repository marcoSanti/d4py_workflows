...
class StreamToFile(ConsumerPE):
    ...
    def _process(self, data):
        ...
        try:
            ...
            fout1 = directory + '/copy_%s_%s_preprpcessed.SAC' % (station, counter)
            fout2 = directory + '/copy_1_%s_%s_preprpcessed.SAC' % (station, counter)
            fout3 = directory + '/copy_2_%s_%s_preprpcessed.SAC' % (station, counter)
...
def calc_fft(str1, type, shift):
    if type is not None:
        ...
        print("station %s and network %s - size in calc_fft %s " % (str1[0].stats['station'], str1[0].stats['network'],
                                                                    size))
